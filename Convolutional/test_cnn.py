...
# Test adding an input layer to the model
def test_add_input_layer():
    model = CNN()
    model.add_input_layer(shape=(256, 256, 3), name="input0")
    assert True

# Test appending a Conv2D layer to the model
...
# Test appending a MaxPooling2D layer to the model
...
# Test adding a Flatten layer to the model
...
# Test appending a Dense layer to the model
...
# Test getting weights without biases for dense layers
...
# Test getting weights without biases for convolutional layers
...
# Test getting weights without biases for convolutional and other layers
...
# Test getting biases for dense layers
...
# Test getting biases for convolutional layers
...
# Test setting weights without biases
...
# Test removing the last layer from the model
