...
def test_weights():
    # Test the set_weights and get_weights functions of LinearAssociator class
    input_dimensions = 4
    number_of_nodes = 9
...
def test_predict_linear():
    # Test the predict function of LinearAssociator class with linear transfer function
    input_dimensions = 2
    number_of_nodes = 5
    model = LinearAssociator(input_dimensions=input_dimensions, number_of_nodes=number_of_nodes,
...
def test_predict_hard_limit():
    # Test the predict function of LinearAssociator class with hard limit transfer function
    input_dimensions = 2
    number_of_nodes = 5
    model = LinearAssociator(input_dimensions=input_dimensions, number_of_nodes=number_of_nodes,
                    transfer_function="Hard_limit")
...
def test_pseudo_inverse_fit():
    # Test the fit_pseudo_inverse function of LinearAssociator class
    input_dimensions = 9
    number_of_nodes = 5
    model = LinearAssociator(input_dimensions=input_dimensions, number_of_nodes=number_of_nodes,
                    transfer_function="Linear")
...
def test_train_linear_delta():
    # Test the train function of LinearAssociator class with linear transfer function using delta learning rule
    input_dimensions = 5
    number_of_nodes = 9
    for i in range(10):
        model = LinearAssociator(input_dimensions=input_dimensions, number_of_nodes=number_of_nodes,
...
def test_train_hardlim_delta():
    # Test the train function of LinearAssociator class with hard limit transfer function using delta learning rule
    input_dimensions = 5
    number_of_nodes = 7
    for i in range(10):
        model = LinearAssociator(input_dimensions=input_dimensions, number_of_nodes=number_of_nodes,
        ...
        out = model.predict(X_train)
        model.set_weights(np.random.randn(*model.get_weights().shape))
        model.train(X_train, out, batch_size=10, num_epochs=150, alpha=0.1, gamma=0.1, learning="Delta")
        new_out = model.predict(X_train)
        np.testing.assert_array_almost_equal(out, new_out, decimal=4)

def test_calculate_mean_squared_error():
    # Test the calculate_mean_squared_error function of LinearAssociator class
    input_dimensions = 5
    number_of_nodes = 7
    number_of_samples = 3
    model = LinearAssociator(input_dimensions=input_dimensions, number_of_nodes=number_of_nodes,
    ...
    np.testing.assert_array_almost_equal(mse, 5.4740, decimal=4)
    ...
    target = np.random.randn(number_of_nodes, number_of_samples)
    mse = model.calculate_mean_squared_error(X_train, target)
    np.testing.assert_array_almost_equal(mse, 1.4552, decimal=4)
