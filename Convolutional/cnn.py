...
class CNN(object):
    ...
    def append_dense_layer(self, num_nodes,activation="relu",name="",trainable=True):
        """
         ...
         :return: None
         """
        dense_layer = keras.layers.Dense(units=num_nodes, activation=activation, trainable=trainable, name=name)
    ...
    def append_conv2d_layer(self, num_of_filters, kernel_size=3, padding='same', strides=1,
        ...
        """
         ...
         :return: Layer object
         """
        conv2D_layer = keras.layers.Conv2D(num_of_filters, kernel_size, strides=strides, activation=activation, padding=padding, name=name, trainable=trainable)
    ...
    def append_maxpooling2d_layer(self, pool_size=2, padding="same", strides=2,name=""):
        """
         ...
         :return: Layer object
         """
        max_pool_layer = keras.layers.MaxPool2D(pool_size=pool_size, strides=strides, padding=padding, name=name)
        self.model.add(max_pool_layer)
    ...
    def set_training_flag(self,layer_numbers=[],layer_names="",trainable_flag=True):
        ...
        # Set the trainable flag for a layer
    ...
    def get_weights_without_biases(self,layer_number=None,layer_name=""):
        ...
        # Return the weight matrix without biases
    ...
    def load_a_model(self,model_name="",model_file_name=""):
        ...
        self.model = keras.models.Sequential()
        if model_name == "VGG16":
            load = keras.applications.vgg16.VGG16()
        elif model_name == "VGG19":
            load = keras.applications.vgg19.VGG19()
        else:
            load = keras.models.load_model(model_file_name)
    ...
    def set_loss_function(self, loss="SparseCategoricalCrossentropy"):
        ...
        # Set the loss function depending on its type
    ...
    def set_optimizer(self,optimizer="SGD",learning_rate=0.01,momentum=0.0):
        ...
        if optimizer == "SGD":
            ...
            self.model.optimizer = keras.optimizers.Adagrad(learning_rate=learning_rate, momentum=momentum)
        # Set the optimizer
    ...
    def evaluate(self,X,y):
        ...
        # Return the evaluated loss and metrics
